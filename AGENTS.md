...
- Закоммиченное изменение → строка-итог в `CHANGELOG.md` под `## Внесённые изменения` («что стало», без сырой формулировки); если оно закрывало пункт `## Планы` — пункт уходит.
