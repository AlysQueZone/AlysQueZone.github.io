...
- Звуки гамбы — рандом-пулы из `media/sounds/gamba-*` (спин 3 / выигрыш 5 / супер 3 / проигрыш 2, старые + новые равноправны); спин — one-shot без лупа `gamba-bg`; источник фраз — MemeAlerts webm → `ffmpeg -vn libmp3lame`.
