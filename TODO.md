...
- [x] rate_limit и daily limit отображается в supabase как 500 ошибка. Это кажется не ок.
  - [x] Там еще 400ки тоже валятся.
...
- [x] Добавить звук из видео tyapa-tyapa.mp4 в колесо, видео-файл удалить после создания аудио.
- [x] Переписать ник в карточке "Привет 1AxeJ" на "AkseLWalkerQuE".
